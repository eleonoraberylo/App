...
let width=innerWidth,height=innerHeight,points=[],clock=0,last=0,frame=0,scene='gathering',pulse=-1,tint='#cbd3cc',paused=media.matches;
...
function draw(dt){
 ...
 for(let j=0;j<points.length;j++){
  ...
  const size=.85+Math.pow(p.s,6)*.8;
