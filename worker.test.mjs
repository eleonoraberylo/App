...
test('typing unlocks at 15 / 1.4 seconds, never before',()=>{for(const elapsed of [0,6500,10000,15000/1.4-.001])assert.equal(IntroTiming.canType(elapsed),false);assert.equal(IntroTiming.canType(15000/1.4),true);assert.equal(IntroTiming.canType(90000),true);});
