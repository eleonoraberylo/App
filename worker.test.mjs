...
test('typing unlocks at 13 seconds, never before',()=>{for(const elapsed of [0,8000,12000,12999])assert.equal(IntroTiming.canType(elapsed),false);assert.equal(IntroTiming.canType(13000),true);assert.equal(IntroTiming.canType(90000),true);});
