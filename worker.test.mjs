...
test('typing unlocks at 8 seconds, never before',()=>{for(const elapsed of [0,5500,7000,7999])assert.equal(IntroTiming.canType(elapsed),false);assert.equal(IntroTiming.canType(8000),true);assert.equal(IntroTiming.canType(90000),true);});
